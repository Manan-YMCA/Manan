...
export function Footer() {
  return (
    <footer className="border-t border-black/10 dark:border-white/10 bg-white/40 dark:bg-black/50 backdrop-blur-lg px-6 py-8">
      <div className="mx-auto max-w-5xl flex flex-col md:flex-row md:justify-between gap-8">
      ...
      <div className="mx-auto mt-8 max-w-5xl border-t border-black/10 dark:border-white/10 pt-4 text-center text-sm text-black/50 dark:text-white/50">
