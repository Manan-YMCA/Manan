...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/members", element: <Suspense><Members /></Suspense> },
      { path: "/events", element: <Suspense><Events /></Suspense> },
  ...
  },
  {
    ...
    children: [
      { index: true, element: <Suspense><AdminDashboard /></Suspense> },
      { path: "members", element: <Suspense><AdminMembers /></Suspense> },
      { path: "members/new", element: <Suspense><NewMember /></Suspense> },
      { path: "events", element: <Suspense><AdminEvents /></Suspense> },
      { path: "events/new", element: <Suspense><NewEvent /></Suspense> },
      { path: "events/:id", element: <Suspense><EditEvent /></Suspense> },
      { path: "gallery", element: <Suspense><AdminGallery /></Suspense> },
      { path: "gallery/new", element: <Suspense><NewGalleryItem /></Suspense> },
    ],
  },
]);
