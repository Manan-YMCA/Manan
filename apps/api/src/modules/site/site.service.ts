...
import { SiteContentPayload } from "./site.validation.js";

const defaultSiteContent: typeof siteContent.$inferInsert = {
  id: "default",
  heroTitle: "Manan",
...
export const siteService = {
  ...
  async updateSiteContent(payload: SiteContentPayload) {
